...
func main() {
	...
	for fileScanner.Scan() {
		...
		switch {
		case section1Start >= section2Start && section1Start <= section2End:
			overlapCount++
		case section1End >= section2Start && section1End <= section2End:
			overlapCount++
		case section2Start >= section1Start && section2Start <= section1End:
			overlapCount++
		case section2End >= section1Start && section2End <= section1End:
			overlapCount++
		}
	}
